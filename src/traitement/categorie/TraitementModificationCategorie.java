	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(e == this.fenetreModifCategorie.getBouttonValider()){
			...
			if(s.equals("Rechercher")){
				...
				if(!nom.equals("")){
					...
					if(cle != 0){
						...
						this.fenetreModifCategorie.getPlace().show();
						this.fenetreModifCategorie.getPrix().show();
			...
			if(s.equals("Modifier")){
				boolean modif;
				if(!this.fenetreModifCategorie.getNom().equals("") && !this.fenetreModifCategorie.getPlace().equals("") && !this.fenetreModifCategorie.getPrix().equals("") ){
					String nom2=this.fenetreModifCategorie.getNom().getText();
					...
					modif=connect.gestionCategorie.ModifClient(this.fenetreModifCategorie.getCleCategorie(),nom,place,prix);
					if(modif){
