...
import BDD.Connect;
import traitement.hotel.TraitementSuppressionHotel;

/**
 * Fenêtre pour supprimer un hôtel
 * 
...
public class FenetreSupprimerHotel extends JFrame {
	...
	public FenetreSupprimerHotel(int cle, Connect connect) {
		...
		getBouttonValider().addActionListener(new TraitementSuppressionHotel(this, this.connect, this.cle));
		getBouttonAnnuler().addActionListener(new TraitementSuppressionHotel(this, this.connect, this.cle));
