...
import BDD.Connect;
import traitement.chambre.TraitementAjoutChambre;

/**
 * Fenêtre qui permet d'ajouter une chambre
 * 
...
public class FenetreAjouterChambre extends JFrame {
	...
	public FenetreAjouterChambre(int cleCategorie, Connect connect) {
		...
		getBouttonValider().addActionListener(new TraitementAjoutChambre(this, this.connect, cleCategorie));
		getBouttonAnnuler().addActionListener(new TraitementAjoutChambre(this, this.connect, cleCategorie));
