...
import BDD.Connect;
import traitement.categorie.TraitementAjoutCategorie;

/**
 * Fenêtre avec un formulaire pour pouvoir ajouter une catégorie
 * 
...
public class FenetreAjouterCategorie extends JFrame {
	...
	private JTextField prix = new JTextField("format pp.pp");
	...
	public FenetreAjouterCategorie(int cleHotel, Connect connect) {
		...
		getBouttonValider().addActionListener(new TraitementAjoutCategorie(this, this.connect, cleHotel));
		getBouttonAnnuler().addActionListener(new TraitementAjoutCategorie(this, this.connect, cleHotel));
