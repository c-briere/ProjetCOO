...
import traitement.ligne.TraitementSupprimerLigne;

/**
 * Fenêtre pour supprimer une ligne
 * 
...
public class FenetreSupprimerLigne extends JFrame {
	...
	public FenetreSupprimerLigne(Connect connect, ArrayList<Ville> ville) {
		...
		getBouttonValider().addActionListener(new TraitementSupprimerLigne(this, this.connect));
		getBouttonAnnuler().addActionListener(new TraitementSupprimerLigne(this, this.connect));
