...
import BDD.Connect;
import traitement.ville.TraitementAjoutVille;

/**
 * Fenêtre pour ajouter une ville
 * 
...
public class FenetreAjouterVille extends JFrame {
	...
	public FenetreAjouterVille(Connect connect) {
		...
		getBouttonValider().addActionListener(new TraitementAjoutVille(this, this.connect));
		getBouttonAnnuler().addActionListener(new TraitementAjoutVille(this, this.connect));
