...
import traitement.trajet.TraitementModifTrajet;

/**
 * Fenêtre sur la modification d'un trajet d'abord on cherche le trajet et
 * ensuite on peut le modifier
 * 
 * @author BRIERE / CARDON
 *
 */
public class FenetreModifPlanning extends JFrame {
	...
	public FenetreModifPlanning(Connect connect, int cleLigne) {
		super("Modification d'un trajet");
		this.connect = connect;
		this.cleLigne = cleLigne;
		getBouttonValider().addActionListener(new TraitementModifTrajet(this, this.connect, this.cleLigne));
		getBouttonAnnuler().addActionListener(new TraitementModifTrajet(this, this.connect, this.cleLigne));
		...
		getPassager1ereclasse().setVisible(false);
		getPrix1ereclasse().setVisible(false);
		getPassager2emeclasse().setVisible(false);
		getPrix2emeclasse().setVisible(false);
		getAnnulable().setVisible(false);
	...
	/**
	 * @param passager1ereclasse
	 *            the passager1ereclasse to set
	 */
	...
	/**
	 * @param prix1ereclasse
	 *            the prix1ereclasse to set
	 */
	...
	/**
	 * @param passager2emeclasse
	 *            the passager2emeclasse to set
	 */
	...
	/**
	 * @param prix2emeclasse
	 *            the prix2emeclasse to set
	 */
