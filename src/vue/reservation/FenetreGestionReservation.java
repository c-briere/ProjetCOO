...
public class FenetreGestionReservation extends JFrame{
	...
	public void choixHotel(String heureRetour,String classeRetour,double prixRetour, ArrayList<HotelRestant> hotel){
		...
		if(hotel.size()!=0 || hotel!=null){
			...
			for(int i =0;i<hotel.size();i++){
				getChoixHotel().addItem(hotel.get(i).getNom()+" "+hotel.get(i).getNbPlaceRestante()+" chambres restantes");
			}
	...
	public void choixCategorie(int idHotel, ArrayList<Categorie> categorie){
		...
		for(int i =0;i<categorie.size();i++){
			getChoixCategorie().addItem(categorie.get(i).getNom()+" "+categorie.get(i).getPlace()+"places"+" "+categorie.get(i).getPrix()+" euros");
		}
	...
	/**
	 * @param bouttonNextClient the bouttonNextClient to set
	 */
	...
	/**
	 * @param bouttonNextChoixDate the bouttonNextChoixDate to set
	 */
	...
	/**
	 * @param choixVille the choixVille to set
	 */
	...
	/**
	 * @param bouttonNextChoixAller the bouttonNextChoixAller to set
	 */
	...
	/**
	 * @param choixClasse the choixClasse to set
	 */
	...
	/**
	 * @param bouttonNextChoixRetour the bouttonNextChoixRetour to set
	 */
	...
	/**
	 * @param bouttonNextChoixHotel the bouttonNextChoixHotel to set
	 */
	...
	/**
	 * @param cleVilleArrive the cleVilleArrive to set
	 */
	...
	/**
	 * @param choixHotel the choixHotel to set
	 */
	...
	/**
	 * @param nbPersonneVoyage the nbPersonneVoyage to set
	 */
	...
	/**
	 * @param bouttonNextChoixCategorie the bouttonNextChoixCategorie to set
	 */
	...
	/**
	 * @param bouttonNextChoixChambre the bouttonNextChoixChambre to set
	 */
	...
	/**
	 * @param cleClient the cleClient to set
	 */
	...
	/**
	 * @param cleLigneAller the cleLigneAller to set
	 */
	...
	/**
	 * @param classeAller the classeAller to set
	 */
	...
	/**
	 * @param heureAller the heureAller to set
	 */
	...
	/**
	 * @param cleVilleDepart the cleVilleDepart to set
	 */
	...
	/**
	 * @param choixChambre the choixChambre to set
	 */
	...
	/**
	 * @param cleChambre the cleChambre to set
	 */
	...
	/**
	 * @param prixRetour the prixRetour to set
	 */
	...
	/**
	 * @param prixAller the prixAller to set
	 */
	...
	/**
	 * @param cleLigneRetour the cleLigneRetour to set
	 */
	...
	/**
	 * @param classeRetour the classeRetour to set
	 */
