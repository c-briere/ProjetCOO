...
public class FenetreModifPlanning extends JFrame{
	...
	public FenetreModifPlanning(Connect connect,int cleLigne){
		...
		bouttonValider.addActionListener(new TraitementModifTrajet(this,this.connect,this.cleLigne));
		bouttonAnnuler.addActionListener(new TraitementModifTrajet(this,this.connect,this.cleLigne));
		...
		passager1ereclasse.hide();
		prix1ereclasse.hide();
		passager2emeclasse.hide();
		prix2emeclasse.hide();
		annulable.hide();
