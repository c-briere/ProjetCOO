...
public class FenetreAjouterLigne extends JFrame {
	...
	public FenetreAjouterLigne(Connect connect, ArrayList<Ville> ville) {
		...
		bouttonValider.addActionListener(new TraitementAjoutLigne(this, this.connect));
		bouttonAnnuler.addActionListener(new TraitementAjoutLigne(this, this.connect));
		...
		panel3.add(new JLabel("choix de la ville de depart"));
		panel3.add(choixVilleAller);

		JPanel panel4 = new JPanel(new FlowLayout());

		panel4.add(new JLabel("choix de la ville de retour"));
